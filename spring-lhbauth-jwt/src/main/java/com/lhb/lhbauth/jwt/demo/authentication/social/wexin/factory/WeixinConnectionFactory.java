...
import com.lhb.lhbauth.jwt.demo.authentication.social.wexin.provider.WeixinGZHServiceProvider;
...
public class WeixinConnectionFactory extends OAuth2ConnectionFactory<Weixin> {
    ...
    public WeixinConnectionFactory(String providerId, String appId, String appSecret) {
        //        TODO 改成原来的
        super(providerId, new WeixinGZHServiceProvider(appId, appSecret), new WeixinAdapter());
    }
